...
implements Plugin {
    ...
    public BypassDisableFunctions() {
        ...
        this.memPayloadComboBox = new JComboBox<String>(BYPASS_MEM_PAYLOAD_LINUX);
        ...
        this.envPayloadComboBox = new JComboBox<String>(BYPASS_ENV_PAYLOAD);
        ...
        this.fpmAddressComboBox = new JComboBox<String>(BYPASS_FPM_ADDRESS);
        ...
        this.amcPayloadComboBox = new JComboBox<String>(BYPASS_AMC_PAYLOAD);
    ...
    private byte[] generateExt(String cmd) throws Exception {
        ...
        try {
            suffix = !this.payload.isWindows() ? "so" : "dll";
        } catch (Exception e) {
            Log.error(e);
        }
        int start = EXT_INFO.get(String.format("ant_x%s_%s_start", bits, suffix));
        int end = EXT_INFO.get(String.format("ant_x%s_%s_end", bits, suffix));
