...
extends JPanel {
    ...
    private void initComponents() {
        ...
        this.setLayout(new MigLayout("insets dialog,hidemode 3", "[][][][][]", "[][][][][][][][][][][][100,top]"));
        scrollPaneLabel.setText("JScrollPane:");
        this.add((Component)scrollPaneLabel, "cell 0 0");
        ...
        this.add((Component)scrollPane13, "cell 1 0,grow,width 70,height 40");
        this.add((Component)scrollBar2, "cell 2 0 1 6,growy");
        scrollBar3.setEnabled(false);
        this.add((Component)scrollBar3, "cell 2 0 1 6,growy");
        scrollBar7.putClientProperty("JScrollBar.showButtons", true);
        this.add((Component)scrollBar7, "cell 2 0 1 6,growy");
        scrollBar8.setEnabled(false);
        scrollBar8.putClientProperty("JScrollBar.showButtons", true);
        this.add((Component)scrollBar8, "cell 2 0 1 6,growy");
        separator2.setOrientation(1);
        this.add((Component)separator2, "cell 2 0 1 6,growy");
        slider2.setOrientation(1);
        slider2.setValue(30);
        this.add((Component)slider2, "cell 2 0 1 6,growy,height 100");
        ...
        slider4.setValue(30);
        this.add((Component)slider4, "cell 2 0 1 6,growy,height 100");
        this.progressBar3.setOrientation(1);
        this.progressBar3.setValue(60);
        this.add((Component)this.progressBar3, "cell 2 0 1 6,growy");
        this.progressBar4.setOrientation(1);
        this.progressBar4.setValue(60);
        this.progressBar4.setStringPainted(true);
        this.add((Component)this.progressBar4, "cell 2 0 1 6,growy");
        ...
        this.add((Component)toolBar2, "cell 2 0 1 6,growy");
        panel2.setBorder(new TitledBorder("TitledBorder"));
        panel2.setLayout(new FlowLayout());
        this.add((Component)panel2, "cell 3 0 1 6,grow");
        scrollBarLabel.setText("JScrollBar:");
        this.add((Component)scrollBarLabel, "cell 0 1");
        scrollBar1.setOrientation(0);
        this.add((Component)scrollBar1, "cell 1 1,growx");
        scrollBar4.setOrientation(0);
        scrollBar4.setEnabled(false);
        this.add((Component)scrollBar4, "cell 1 2,growx");
        panel3.setOpaque(false);
        panel3.setLayout(new MigLayout("ltr,insets 0,hidemode 3", "[]", "[][][][]"));
        label4.setText("HTML:");
        panel3.add((Component)label4, "cell 0 0");
        label3.setText("<html>JLabel HTML<br>Sample <b>content</b><br> <u>text</u> with <a href=\"#\">link</a></html>");
        panel3.add((Component)label3, "cell 0 1");
        ...
        panel3.add((Component)scrollPane15, "cell 0 2,grow");
        ...
        panel3.add((Component)scrollPane16, "cell 0 3,grow");
        this.add((Component)panel3, "cell 4 0 1 8,aligny top,growy 0");
        scrollBar5.setOrientation(0);
        scrollBar5.putClientProperty("JScrollBar.showButtons", true);
        this.add((Component)scrollBar5, "cell 1 3,growx");
        scrollBar6.setOrientation(0);
        scrollBar6.setEnabled(false);
        scrollBar6.putClientProperty("JScrollBar.showButtons", true);
        this.add((Component)scrollBar6, "cell 1 4,growx");
        separatorLabel.setText("JSeparator:");
        this.add((Component)separatorLabel, "cell 0 5");
        this.add((Component)separator1, "cell 1 5,growx");
        sliderLabel.setText("JSlider:");
        this.add((Component)sliderLabel, "cell 0 6");
        slider1.setValue(30);
        this.add((Component)slider1, "cell 1 6 3 1,aligny top,grow 100 0");
        slider6.setEnabled(false);
        slider6.setValue(30);
        this.add((Component)slider6, "cell 1 6 3 1,aligny top,growy 0");
        ...
        this.slider3.addChangeListener(e -> this.changeProgress());
        this.add((Component)this.slider3, "cell 1 7 3 1,aligny top,grow 100 0");
        ...
        slider5.setValue(30);
        this.add((Component)slider5, "cell 1 7 3 1,aligny top,growy 0");
        progressBarLabel.setText("JProgressBar:");
        this.add((Component)progressBarLabel, "cell 0 8");
        this.progressBar1.setValue(60);
        this.add((Component)this.progressBar1, "cell 1 8 3 1,growx");
        this.progressBar2.setStringPainted(true);
        this.progressBar2.setValue(60);
        this.add((Component)this.progressBar2, "cell 1 8 3 1,growx");
        this.indeterminateCheckBox.setText("indeterminate");
        this.indeterminateCheckBox.addActionListener(e -> this.indeterminateCheckBoxActionPerformed());
        this.add((Component)this.indeterminateCheckBox, "cell 4 8");
        toolTipLabel.setText("JToolTip:");
        this.add((Component)toolTipLabel, "cell 0 9");
        toolTip1.setTipText("Some text in tool tip.");
        this.add((Component)toolTip1, "cell 1 9 3 1");
        toolTip2.setTipText("Tool tip with\nmultiple\nlines.");
        this.add((Component)toolTip2, "cell 1 9 3 1");
        toolBarLabel.setText("JToolBar:");
        this.add((Component)toolBarLabel, "cell 0 10");
        ...
        button1.setIcon(new ImageIcon(this.getClass().getResource("/com/formdev/flatlaf/demo/icons/intellij-showWriteAccess.png")));
        button1.setEnabled(false);
        toolBar1.add(button1);
        this.add((Component)toolBar1, "cell 1 10 3 1,growx");
        splitPaneLabel.setText("JSplitPane:");
        this.add((Component)splitPaneLabel, "cell 0 11");
        ...
        panel10.add((Component)label1, "Center");
        ...
        panel11.add((Component)label2, "Center");
        ...
        panel12.add((Component)label5, "Center");
        ...
        panel13.add((Component)label6, "Center");
        splitPane2.setBottomComponent(panel13);
        splitPane3.setRightComponent(splitPane2);
        this.add((Component)splitPane3, "cell 1 11 4 1,grow");
        if (FlatLafDemo.screenshotsMode) {
            Component[] components;
            for (Component c : components = new Component[]{this.indeterminateCheckBox, toolTipLabel, toolTip1, toolTip2, toolBarLabel, toolBar1, toolBar2, splitPaneLabel, splitPane3}) {
                c.setVisible(false);
            }
        }
    }
