...
implements DigestAlgorithmIdentifierFinder {
    ...
    public AlgorithmIdentifier find(AlgorithmIdentifier algorithmIdentifier) {
        AlgorithmIdentifier algorithmIdentifier2 = algorithmIdentifier.getAlgorithm().equals(PKCSObjectIdentifiers.id_RSASSA_PSS) ? RSASSAPSSparams.getInstance(algorithmIdentifier.getParameters()).getHashAlgorithm() : new AlgorithmIdentifier((ASN1ObjectIdentifier)digestOids.get(algorithmIdentifier.getAlgorithm()), DERNull.INSTANCE);
        return algorithmIdentifier2;
    }

    public AlgorithmIdentifier find(String string) {
        return new AlgorithmIdentifier((ASN1ObjectIdentifier)digestNameToOids.get(string), DERNull.INSTANCE);
    }
