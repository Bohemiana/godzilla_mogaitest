...
public class Retransmission {
    ...
    public String toString() {
        return "Retransmission{listenAddress='" + this.listenAddress + '\'' + ", listenPort=" + this.listenPort + ", targetAddress='" + this.targetAddress + '\'' + ", targetPort=" + this.targetPort + ", retransmissionType=" + (Object)((Object)this.retransmissionType) + '}';
    }
}
