...
extends JDialog {
    ...
    public static String randomReqParameter() {
        ...
        try {
            String[] pms;
            if (ApplicationContext.isOpenC("openRandomReqParameter") && (pms = Db.getSetingValue("RandomReqParameterSize").split("-")).length == 2) {
    ...
    public static String randomRequestParameter(int num) {
        ...
        try {
            if (ApplicationContext.isOpenC("openRandomRequestParameter")) {
                ...
                for (int i = 0; i < num; ++i) {
                    builder.append(ShellSuperRequest.randomOneRequestParameter());
                    builder.append("&");
                }
                if (builder.length() > 1) {
    ...
    private static String randomOneRequestParameter() {
        ...
        if ((v = Db.getSetingValue("RandomRequestParameterSize").split("-")).length == 2) {
